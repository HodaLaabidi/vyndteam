...
public class BusinessSearchRegAndNameAdapter extends RecyclerView.Adapter<BusinessSearchRegAndNameAdapter.MyViewHolder>{
    Context context;
    ...
    private int size;
    public BusinessSearchRegAndNameAdapter(Context context, List<Business> businesses) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // upload images
        Log.e("test iholder", business.getImage());
...
//        else
        ...
        postParams.addProperty("categorizationId", 0);
        postParams.addProperty("keyword", HomeActivity.searchObject.getKeywordBusinessName());
        postParams.addProperty("regionId", HomeActivity.searchObject.getRegion().getId());
        postParams.addProperty("region", "");
        ...
        postParams.addProperty("distance", 0);
        postParams.addProperty("note", 0);
        postParams.addProperty("budget", 0);
        postParams.addProperty("page", 0);

        call = RetrofitServiceFacotry.getBusinessService().getFilteredBusinesses(postParams, 0, Utils.LIMIT);
